...
![](/images/posts/rtrt1/media/image1.png)

![](/images/posts/rtrt1/media/image2.png)

毛发，皮肤，体积雾的渲染被鸽掉了，不知道以后还有没有

![](/images/posts/rtrt1/media/image3.png)

![](/images/posts/rtrt1/media/image4.png)

光追会是未来，而且永远是（

![](/images/posts/rtrt1/media/image5.png)

18年nvdia就做出了图灵架构的支持光追的硬件

有2500亿的市场，好吧但是现在好像都拿来做ai了（悲

![](/images/posts/rtrt1/media/image6.png)

光追对环境光支持非常好，而且理论上就是支持无限光源

![](/images/posts/rtrt1/media/image7.png)

RTX实际上就是为了做光线追踪而存在

![](/images/posts/rtrt1/media/image8.png)

理论上RTX一秒钟可以射出一百亿次光线，但是因为不可能始终满载运行（多pass，以及其他任务），实际上最终只能给一个像素分一次采样，也就是射一根光线

![](/images/posts/rtrt1/media/image9.png)

一次SSP就是四（三）条光线，一次光栅化，一个是直接光的可见性的光线，然后是弹射的光线，然后是弹射后的点与光的可见性

![](/images/posts/rtrt1/media/image10.png)

那么显然1SSP会产生非常多的噪点，那么实时光线追踪的核心就是降噪来去掉这些噪声

![](/images/posts/rtrt1/media/image11.png)

![](/images/posts/rtrt1/media/image12.png)
...
![](/images/posts/rtrt1/media/image13.png)
...
![](/images/posts/rtrt1/media/image14.png)
...
![](/images/posts/rtrt1/media/image15.png)

对于动作向量，我们需要根据当前帧去找他上一帧的位置

![](/images/posts/rtrt1/media/image16.png)
...
![](/images/posts/rtrt1/media/image17.png)
...
![](/images/posts/rtrt1/media/image18.png)![](/images/posts/rtrt1/media/image19.png)

降噪前后对比

亮度出现明显差异是因为降噪前有很多噪点的值实际上远远大于255，被显示器截断到255了，导致结果偏暗。如果显示器支持HDR，可能亮度就很接近了

![](/images/posts/rtrt1/media/image20.png)
