...
export const metadata: Metadata = {
  title: "关于",
  description: "关于 Tasrovy 的 GAMES101、GAMES202 课程笔记与图形学实践",
};
  ...
  return (
    <div className="min-h-screen bg-white pt-16 text-slate-950 dark:bg-slate-950 dark:text-white">
      <div className="mx-auto max-w-5xl px-4 py-20 md:py-28">
        ...
        <h1 className="mt-5 max-w-4xl text-5xl font-bold tracking-tight md:text-7xl">记录课程怎么学，作业怎么解，代码怎么跑。</h1>
        ...
        <div className="mt-16 grid gap-12 md:grid-cols-[0.7fr_1.3fr]">
          ...
          <div className="space-y-6 text-lg leading-8 text-slate-600 dark:text-slate-300">
            <p>这个网站主要整理 GAMES101 与 GAMES202 的课程笔记。内容包括课堂知识、公式推导、作业思路、代码实现和调试记录，而不是脱离学习过程重新包装的教程。</p>
            <p>TasrovyRenderer 是课程之外持续推进的工程项目：使用 C++20、HLSL 与 Vulkan，从 RenderGraph、RHI 和资源同步开始，逐步实现延迟 PBR、阴影、屏幕空间效果与时域后处理。</p>
